...
sumber_kamera = [buka_rtsp(kam["ip"], kam["username"], kam["password"]) for kam in KAMERA_LIST]
    ...
    while True:
        ...
        for idx, kap in enumerate(kamera_caps):
            ...
            with kunci_status:
                ...
                frame_per_kamera[idx] = cv2.resize(frame_annotasi, UKURAN_TARGET)  # Simpan frame per kamera
